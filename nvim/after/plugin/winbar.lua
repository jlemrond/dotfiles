...
local function show_winbar()
	...
	if status_web_devicons_ok then
		file_icon = web_devicons.get_icon(filename, file_type, { default = true })
	...
	local formatted = value .. " %#" .. hl_winbar .. "#%f" .. "%#" .. hl_modified .. "# %m%*"
	pcall(vim.api.nvim_set_option_value, "winbar", formatted, { scope = "local" })
end
